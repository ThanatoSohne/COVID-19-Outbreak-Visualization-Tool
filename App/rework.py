...
xls = '.xlsx'
newURL = ecdc + str(ahora.strftime('%m')) + '-' + str(ahora.strftime('%d')) + xls
...
blanche.update_layout(showlegend=False,
                      title="ECDC's Data Showing the Infected Cases with Daily Deaths as Time Progressed")
            ...
            [
                dbc.Row(
                    [
                        dbc.Col(
                            [
                                html.H3("The Absolute Immensity fo the Infection",
                                        style={
                                            "position": "relative",
                                            "text-align": "center"
                                        }),
...
# app.callback(
#     Output(f"submenu-1-collapse", "is_open"),
#     [Input(f"submenu-1", "n_clicks")],
#     [State(f"submenu-1-collapse", "is_open")],
# )(toggle_collapse)
#
# app.callback(
#     Output(f"submenu-1", "className"),
#     [Input(f"submenu-1-collapse", "is_open")],
# )(set_navitem_class)

...
def akScrape():
    try:
        ...
        print(cl('Exception was raised for AK scraper.', 'green'))
        pass
...
def alScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for AL scraper.', 'green'))
        pass
...
def arScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for AR scraper.', 'green'))
        pass
...
def aSamScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for AS scraper.', 'green'))
        pass
...
def azScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[142].split('\n')[1]) == 'Apache' and (hold[156].split('\n')[1]) == 'Yuma':
        
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[142:157]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for AZ scraper.', 'green'))
        pass
...
def caScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for CA scraper.', 'green'))
        pass
...
def coScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for CO scraper.', 'green'))
        pass
...
def ctScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for CT scraper.', 'green'))
        pass
...
def dcScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for DC scraper.', 'green'))
        pass
...
def deScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for DE scraper.', 'green'))
        pass
...
def flScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[157].split('\n')[1]) == 'Alachua' and (hold[223].split('\n')[1]) == 'Washington':
        
            file = open(csvfile, "w")
            file.write(headers)
                
            for h in hold[157:224]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for FL scraper.', 'green'))
        pass
...
def gaScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for GA scraper.', 'green'))
        pass
...
def guScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for GU scraper.', 'green'))
        pass
...
def hiScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for HI scraper.', 'green'))
        pass
...
def idScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[63].split('\n')[1]) == 'Ada' and (hold[106].split('\n')[1]) == 'Washington':
    
            file = open(csvfile, "w")
            file.write(headers)
                        
            for h in hold[63:107]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for ID scraper.', 'green'))
        pass
...
def ilScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[87].split('\n')[1]) == 'Adams' and (hold[183].split('\n')[1]) == 'Woodford':
        
            file = open(csvfile, "w")
            file.write(headers)
                        
            for h in hold[87:102]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for IL scraper.', 'green'))
        pass
...
def inScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[76].split('\n')[1]) == 'Adams' and (hold[167].split('\n')[1]) == 'Whitley':
        
            file = open(csvfile, "w")
            file.write(headers)
                
            for h in hold[76:168]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for IN scraper.', 'green'))
        pass
...
def ioScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended        
        if (hold[76].split('\n')[1]) == 'Adair' and (hold[174].split('\n')[1]) == 'Wright':
    
            file = open(csvfile, "w")
            file.write(headers)
        
            for h in hold[76:175]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for IO scraper.', 'green'))
        pass
...
def kaScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[90].split('\n')[1]) == 'Allen' and (hold[194].split('\n')[1]) == 'Wyandotte':
           
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[90:195]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for KA scraper.', 'green'))
        pass
...
def kyScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for KY scraper.', 'green'))
        pass
...
def laScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended    
        if (hold[133].split('\n')[1]) == 'Acadia' and (hold[198].split('\n')[1]) == 'Winn':
                
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[133:199]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for LA scraper.', 'green'))
        pass
...
def maScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for MA scraper.', 'green'))
        pass
...
def mdScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[102].split('\n')[1]) == 'Allegany' and (hold[126].split('\n')[1]) == 'Unassigned' and holdDC[123].split('\n')[3] == "District of Columbia":
                    
            file = open(csvfile, "w")
            file.write(headers)
                
            for h in hold[102:126]:
                take = h.split('\n')
                file.write(take[1] + "," + md + "," + str(fips.get_county_fips(take[1],state=md)).strip() + ","
                           + str(geocoder.opencage(take[1] + co + "," + md, key='').latlng).strip('[]') + "," 
                           + take[3].replace(',','') + "," 
                           + str(int(take[5].replace(',','')) + int(take[7].replace(',',''))) + "\n")
            ...
            file.write(hold[126].split('\n')[1] + "," + md + "," + str(fips.get_state_fips(md)).strip() + "," + str(liegen.geocode(md).latitude) + "," 
                       ...
                       + hold[126].split('\n')[3].replace(',','') + "," 
                       + str(int(hold[126].split('\n')[5].replace(',','')) 
                       + int(hold[126].split('\n')[7].replace(',',''))) + "\n")
            
            file.write(holdDC[123].split('\n')[3] + "," + dc + "," 
        ...
        print(cl('Exception was raised for MD scraper.', 'green'))
        pass
...
def meScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for ME scraper.', 'green'))
        pass
...
def miScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for MI scraper.', 'green'))
        pass
...
def mnScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for MN scraper.', 'green'))
        pass
...
def moScrape():
    ...
    #                   + "," + "" + "," + tables[164].findAll('td')[1].text + "\n")
        ...
        print(cl('Exception was raised for MO scraper.', 'green'))
        pass
...
def mpScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for MP scraper.', 'green'))
        pass
...
def msScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for MS scraper.', 'green'))
        pass
...
def mtScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for MT scraper.', 'green'))
        pass
...
def ncScrape():
    try:
        ...
        print(cl('Exception was raised for NC scraper.', 'green'))
        pass
...
def ndScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if hold[70].split('\n')[1] == 'Barnes' and hold[104].split('\n')[1] == 'Williams':
    
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[70:105]:
        ...
        print(cl('Exception was raised for ND scraper.', 'green'))
        pass
...
#                       + hold[130].split('\n')[5] + "\n")
        ...
        print(cl('Exception was raised for NE scraper.', 'green'))
        pass
...
def nhScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for NH scraper.', 'green'))
        pass
...
def njScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended       
        if (hold[80].split('\n')[1]) == 'Atlantic' and (hold[101].split('\n')[1]) == 'Under investigation':
                
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[80:101]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for NJ scraper.', 'green'))
        pass
...
def nmScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[71].split('\n')[1]) == 'Bernalillo' and (hold[100].split('\n')[1]) == 'Valencia':
        ...
        print(cl('Exception was raised for NM scraper.', 'green'))
        pass
def nvScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for NV scraper.', 'green'))
        pass
...
def nyScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for NY scraper.', 'green'))
        pass
...
def ohScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for OH scraper.', 'green'))
        pass
...
def okScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for OK scraper.', 'green'))
        pass
...
def orScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for OR scraper.', 'green'))
        pass
...
def paScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for PA scraper.', 'green'))
        pass
...
def prScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for PR scraper.', 'green'))
        pass
...
def riScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for RI scraper.', 'green'))
        pass
...
def scScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if (hold[73].split('\n')[1]) == 'Abbeville' and (hold[118].split('\n')[1]) == 'York':
                    
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[73:119]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for SC scraper.', 'green'))
        pass
...
def sdScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended     
        if (hold[70].split('\n')[1]) == 'Aurora' and (hold[115].split('\n')[1]) == 'Yankton':
                    
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[70:116]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for SD scraper.', 'green'))
        pass
...
def tnScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended          
        if (hold[27].split('\n')[1]) == 'Anderson' and (hold[123].split('\n')[1]) == 'Pending':
            
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[27:122]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for TN scraper.', 'green'))
        pass
...
def txScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for TX scraper.', 'green'))
        pass
...
def utScrape():
    ...
    try:
        ...
        garCase = hold[82].split('\n')[3]
        garKhaus = hold[82].split('\n')[5]
        garMort = hold[82].split('\n')[7]
        ...
        print(cl('Exception was raised for UT scraper.', 'green'))
        pass
...
def vaScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for VA scraper.', 'green'))
        pass
...
def viScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for VI scraper.', 'green'))
        pass
...
def vtScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for VT scraper.', 'green'))
        pass
...
def waScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for WA scraper.', 'green'))
        pass
...
def wiScrape():
    ...
    try:    
        ...
        print(cl('Exception was raised for WI scraper.', 'green'))
        pass
...
def wvScrape():
    ...
    try:
        ...
        #If it is, then print to the CSV file whose name was created earlier
        #If not, then print out an error message so that the scraper can be mended
        if hold[133].split('\n')[1] == 'Barbour County' and hold[182].split('\n')[1] == 'Wyoming County':
        
            file = open(csvfile, "w")
            file.write(headers)
            
            for h in hold[133:183]:
                take = h.split('\n')
        ...
        print(cl('Exception was raised for WV scraper.', 'green'))
        pass
...
def wyScrape():
    ...
    try:
        ...
        print(cl('Exception was raised for WY scraper.', 'green'))
        pass
